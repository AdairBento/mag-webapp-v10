...
Execute "npm audit (moderate+)" "audit"   { In-Api { if($ShowDetails){ npm audit --audit-level=moderate } else { npm audit --audit-level=moderate 2>&1 | Out-Null } }; $global:LASTEXITCODE=0 }
